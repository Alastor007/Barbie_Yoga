...
public class exs_list_tab2 extends AppCompatActivity {

    ListView listViewww;

    private DatabaseHelper_tabl mDBHelper_ex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exs_list_tab2);

        tableName = "allexs";

        mDBHelper_ex = new DatabaseHelper_tabl(this, "barbie_yogas.db", null, 7);
        mDBHelper_ex.openDb();

        Cursor cursor = mDBHelper_ex.getExs(tableName);
        cursor.moveToFirst();
        ...
        ListView listView = (ListView) findViewById(R.id.listView_exs_list_tab2);
        ...
        listViewww = findViewById(R.id.listView_exs_list_tab2);
        ...
        listViewww.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(exs_list_tab2.this, exs_list_tab2_details.class);
        ...
        mDBHelper_ex.closeDb();
    }


    //---------------------------------------кнопка назад-------------------------------------------
    public void exs_goback(View view) {

        Intent intent = new Intent(exs_list_tab2.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
